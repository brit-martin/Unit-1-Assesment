...
```
console.log prints the value you want into the terminal. 
return stops the function and returns the specific value to the function.
```

**_What's the difference between defining and calling a function?_**

```
Calling a function runs the code. Defining it is just giving it a name. 
```
...
```
string is a line of text. Or a string of text. 
```

**_Number_**

```
are numbers. ex 1, -2, -4. You can use postives or negatives.
```
...
```
its one variable that stores multiple values/elements
```
